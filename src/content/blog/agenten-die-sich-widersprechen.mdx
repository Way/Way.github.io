...
Verdrahten musst du das nicht mehr von Hand. Seit Anthropic [Dynamic Workflows in Claude Code](https://claude.com/blog/introducing-dynamic-workflows-in-claude-code) ausgeliefert hat, schreibt Claude die Orchestrierung selbst. Aus einer Beschreibung in natürlicher Sprache entsteht ein Skript, das zig bis hunderte Sub-Agenten in einer Session koordiniert und sich strikt an die Reihenfolge hält. [Cat Wu](https://x.com/_catwu/status/2060054180379689074) zeigt, wie du sogar vorschreiben kannst, wo der Widerspruch hingehört: "Phase 2, zwei Agenten implementieren denselben Code unabhängig. Phase 3, ein Reviewer vergleicht beide." Die Widersprüche sind dann Teil des Plans.
