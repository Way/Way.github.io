...
Block ist dabei nur der lauteste Fall, nicht der größte. Allein in den [ersten sechs Wochen von 2026](https://technode.global/2026/02/13/tech-sector-layoffs-reach-30700-just-6-weeks-into-2026-on-track-to-surpass-2025s-job-cuts-rationalfx/) hat die Tech-Branche über 50.000 Stellen gestrichen. [Amazon](https://www.computerworld.com/article/3816579/tech-layoffs-this-year-a-timeline.html) streicht 16.000 Corporate-Jobs, vor allem in AWS. [Microsoft](https://www.computerworld.com/article/3816579/tech-layoffs-this-year-a-timeline.html) 9.000. [Pinterest](https://www.cbsnews.com/news/ai-layoffs-2026-artificial-intelligence-amazon-pinterest/) löst 15% der Belegschaft auf, um Ressourcen in AI umzuschichten.

Auch in Deutschland ist der Schnitt längst angekommen: [SAP hat 10.000 Stellen abgebaut](https://www.produktion.de/wirtschaft/stellenabbau-rund-3500-menschen-verlassen-sap-367.html), allein in Deutschland 3.500, rund 14% der deutschen Belegschaft. Begründung: "Business AI". Das Muster überall dasselbe: profitable Unternehmen, die sich für eine Welt umbauen, in der kleinere Teams mehr Output liefern.
...
Die Zahlen sind eindeutig: [4% aller öffentlichen GitHub-Commits](https://newsletter.semianalysis.com/p/claude-code-is-the-inflection-point) werden heute schon von Claude Code geschrieben. SemiAnalysis prognostiziert über 20% bis Ende 2026. Kein Experiment mehr. Ein neuer Normalzustand, der sich gerade in Echtzeit etabliert.

Die Stimmen derjenigen, die das Handwerk über Jahrzehnte geprägt haben, sprechen eine klare Sprache. [Ryan Dahl](https://newsletter.semianalysis.com/p/claude-code-is-the-inflection-point), der Erfinder von Node.js, sagt offen: "The era of humans writing code is over." [Andrej Karpathy](https://newsletter.semianalysis.com/p/claude-code-is-the-inflection-point), einer der profiliertesten AI-Forscher weltweit, berichtet, dass seine eigene Fähigkeit, manuell Code zu schreiben, verkümmert. Er trennt inzwischen "Code generieren" und "Code beurteilen" klar als zwei eigenständige Fähigkeiten. Sogar [Linus Torvalds](https://newsletter.semianalysis.com/p/claude-code-is-the-inflection-point) vibe-codet öffentlich auf GitHub. Wir reden hier nicht von Randpersonen. Wir reden von den Gründern und Ikonen des Handwerks.
...
Das klingt erstmal nur nach Effizienzgewinn. Ist es aber nicht. Wenn der teuerste Teil der Feature-Pipeline (Code schreiben) plötzlich fast nichts mehr kostet, verschiebt sich alles, was danach kommt. Die Preise machen das greifbar: Ein Claude-Pro-Abo kostet [$20 im Monat](https://claude.com/pricing). Ein Wissensarbeiter kostet ein Unternehmen $350 bis $500 pro Tag. Selbst wenn der Agent nur einen halben Arbeitstag ersetzt, ist der ROI irgendwo zwischen 10x und 30x. Code ist nicht einfach billiger geworden. Code ist fast gratis.
...
Kein Einzelfall. Ein Muster, das sich gerade überall zeigt. Und es stellt die Grundannahme in Frage, auf der die meisten Tech-Unternehmen aufgebaut sind: dass Skalierung über Headcount läuft.
...
Eine Ansage. Wer sich nicht anpasst, wird dazu gezwungen.
...
Wer nur tippt, ohne zu testen oder das eigene Produkt zu benutzen, wird ersetzbar. Wer Verantwortung übernimmt, die über Code hinausgeht, war noch nie so wertvoll.
...
Klingt zynisch? Ist eine Überlebensstrategie. Wer versteht, wie der gesamte Delivery-Prozess funktioniert (nicht nur das Coding), ist genau die Person, die in einer AI-Welt gebraucht wird. Denn irgendwer muss definieren, was die Agents tun, prüfen, ob sie es richtig tun, und die Verantwortung übernehmen, wenn es schiefgeht. Malte Ubl, CTO von Vercel, [beschreibt genau das als seinen neuen Job](https://newsletter.semianalysis.com/p/claude-code-is-the-inflection-point): nicht mehr selbst Code schreiben, sondern AI-Outputs reviewen, Richtung geben, Qualität sichern. Kein Abstieg. Eher die Rolle, die in einer AI-first-Welt den größten Hebel hat.

## Was bleibt

Das alte Modell ("viele Engineers, viel Code, langsamer Prozess") stirbt. Keine Prognose, sondern Realität. [Block macht den Schnitt.](https://sfstandard.com/2026/02/26/block-lays-off-staff/) Startups zeigen, was kleine Teams können. Solo-Entwickler bauen Millionen-Businesses. [Laut Stack Overflow](https://newsletter.semianalysis.com/p/claude-code-is-the-inflection-point) nutzen bereits 84% aller Entwickler AI-Tools, aber nur 31% arbeiten mit Coding-Agents. Die nächste Welle steht erst am Anfang.

Das neue Modell: wenige Köpfe mit viel Verantwortung, starker AI-Unterstützung und extrem schneller Iteration.

Für Entwickler, die sich über die Anzahl abgearbeiteter Tickets definieren, wird das unbequem. Für alle, die bereit sind, Verantwortung jenseits von Code zu übernehmen, öffnet sich gerade ein Fenster, das es so noch nie gab.

Das Ironische daran: Die Technologie, die Codezeilen entwertet, macht die Menschen dahinter wichtiger. Wer versteht, warum etwas gebaut wird (nicht nur wie), hat plötzlich den längeren Hebel. Vielleicht war "Code schreiben" nie die eigentliche Kernkompetenz. Vielleicht merken wir das jetzt nur zum ersten Mal.
