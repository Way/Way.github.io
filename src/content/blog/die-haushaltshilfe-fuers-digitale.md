...
Mit Assistenten verschiebt sich die Erwartung. Die Nutzer von morgen erwarten noch stärker, dass Software ihnen nicht das richtige Werkzeug bereitstellt, sondern die Aufgabe nahezu vollständig abnimmt. Im B2B habe ich das unter [Service as Software](/blog/service-as-software) beschrieben. Jetzt kommt dieselbe Erwartung beim Endkunden an.

Für bestehende Software heißt das, dass die Oberfläche an Wert verliert und alles dahinter gewinnt: Zugang, saubere Daten, klare Rechte, Verfügbarkeit und Auffindbarkeit. Und es gibt eine zweite Zielgruppe. Ein Agent braucht eindeutige Zustände und Fehlermeldungen, die er versteht. „Etwas ist schiefgelaufen, bitte versuche es später erneut“ hilft einem Menschen wenig und einem Agenten gar nicht.
